...
int main(int argc, char** argv)
{
    ...
    nh.param<int>("global_map_width", global_map_width, 10000);
    nh.param<int>("global_map_height", global_map_height, 10000);
    ...
    pf_publisher = nh.advertise<finderbot::PF_Input>("pf_input", 1, true);
    ros::spin();
}